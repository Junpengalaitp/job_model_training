tm_collection = {
    ...
    "Remote work": ("Remote work environment", "Remote work"),
    "tight knit team": ("tight knit team",),
...
cp_collection = {
    ...
    "E-commerce": ("E-commerce", "e-commerce", "ecommerce", "online commerce"),
...
ge_collection = {
    ...
    "customer-focused thinking": ("customer-focused thinking",),
    ...
    "deliver technical requirements": ("deliver technical requirements",),
...
sf_collection = {
    ...
    "interface with clients": ("interface with clients",),
}
...
of_collection = {
    ...
    "operate autonomously": ("operate autonomously",),
    "solid benefits": ("solid benefits",),
    ...
    "paid vacation": ("paid vacation", "2 weeks paid vacation", "6 weeks paid vacation", "Generous vacation policy",
                      ...
                      "paid paternity/adoption leave", "sick leave", "paid time off"),
    ...
    "equity": ("equity", "profit sharing", "stock options"),
