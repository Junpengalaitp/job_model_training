...
from constants.category import pl, ol, lb, fw, cs, pt, ds, dv, we, os_, sv, ap, pf, ps, ge, sf, tl, at, pd, ql, of, tm, \
    se, dt, ai
from model_training_algo.entity_finder import entity_finder
...
TRAIN_DATA = [
    ...
    (D8, {"entities": [(638, 645, ge),
                       (650, 665, ge), (976, 981, lb), (983, 995, fw), (1004, 1014, pl), (1041, 1044, os_),
                       (1049, 1056, os_), (1226, 1237, pd),
                       (1278, 1285, ge), (1491, 1497, pd), (1523, 1530, pd), (240, 247, of),
                       (1396, 1401, pd), (1945, 1960, of), (2069, 2080, pd), (2128, 2142, of),
                       (1365, 1385, of), (1458, 1467, pd), (2431, 2442, sf), (2212, 2221, sf), ]}),
