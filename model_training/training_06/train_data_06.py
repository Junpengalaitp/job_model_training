...
TRAIN_DATA = [
    ...
    (D1, {'entities': [(592, 604, lf), (749, 761, lf), (1342, 1354, lf), (6140, 6152, lf), (560, 565, lf),
                       (1331, 1336, lf), (6026, 6031, lf), (567, 577, pl), (729, 736, pf),
                       (579, 587, lf), (740, 748, lf), (1315, 1323, lf), (6153, 6161, lf), (631, 641, pl),
                       (2652, 2654, dv),
    ...
    (D2, {'entities': [(37, 47, dv), (1412, 1422, dv), (49, 55, pl), (1463, 1469, pl), (2107, 2113, pl), (2581, 2587, pl),
                       (1471, 1476, lf), (2333, 2338, lf), (1478, 1481, ds), (1509, 1526, ap), (2159, 2165, lf),
                       (2169, 2174, lf), (2214, 2224, ds), (2228, 2233, ds),
    ...
    (D5,
     {'entities': [(149, 157, dv), (678, 686, dv), (1251, 1259, dv), (184, 200, dv), (204, 218, dv), (3232, 3246, dv),
                   ...
                   (3301, 3305, lf), (3162, 3190, we), (3310, 3314, lf), (3406, 3410, pf), (3455, 3459, pl),
    ...
    (D7,
     {'entities': [(346, 355, dv), (606, 612, lf), (779, 785, lf), (900, 906, lf), (1126, 1132, lf),
    ...
    (D8,
     {'entities': [(442, 444, dv), (493, 505, lf), (524, 527, os_), (1420, 1423, os_), (1693, 1696, os_), (532, 539, os_),
