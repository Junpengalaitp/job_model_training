...
TRAIN_DATA = [
     ...
     (D1, {'entities': [(1071, 1106, we), (1112, 1122, pl), (2484, 2494, pl), (1142, 1149, lb), (2514, 2521, lb),
                        (1154, 1159, lb), (2526, 2531, lb), (1021, 1056, we), (1249, 1254, os_), (1256, 1259, ap),
                        ...
                        (4254, 4287, we), (1918, 1931, lb), (1911, 1915, pl), (2778, 2791, lb), (2792, 2802, dv),
     ...
     (D2, {'entities': [(2422, 2466, we), (137, 146, lb), (449, 458, lb), (1263, 1272, lb), (1889, 1898, lb),
                        (5739, 5748, lb), (5854, 5863, lb), (149, 155, lb), (1804, 1807, dv), (2815, 2832, ap),
                        (2834, 2841, ap), (2887, 2890, pl), (2916, 2921, ap), (3052, 3061, ap), (2972, 2976, os_),
                        (3063, 3068, ap), (3070, 3075, ap)]}),
     (D3, {'entities': [(1465, 1471, lb), (1922, 1928, lb), (1406, 1409, pl), (1602, 1612, pl), (1614, 1618, lb),
     ...
     (D5, {'entities': [(2976, 2983, cp), (2986, 2996, cp), (2028, 2033, ap), (2127, 2132, ap), (3184, 3189, ap),
                        ...
                        (3308, 3314, pl), (3315, 3320, lb), (3347, 3360, lb), (3461, 3464, pf)]}),
     (D6, {'entities': [(2200, 2206, pl), (3476, 3482, pl), (2208, 2211, pf), (2413, 2416, pf), (2215, 2225, pf),
                        (2418, 2421, pf), (2426, 2431, pf), (2304, 2310, lb), (2312, 2317, lb), (2322, 2327, lb),
                        (2339, 2344, lb), (2345, 2356, lb)]}),
     (D7, {'entities': [(1560, 1573, lb), (3534, 3547, lb), (1654, 1660, pl), (3495, 3501, pl), (1661, 1666, lb),
                        (3502, 3507, lb), (1023, 1026, pt), (1192, 1195, pt), (1386, 1389, pt), (1673, 1676, pt),
                        (3514, 3517, pt), (1921, 1945, dv), (3358, 3389, we), (3266, 3269, dv), (2430, 2435, ap),
                        (2529, 2534, ap), (3428, 3433, ap), (4623, 4628, ap), (4961, 4966, ap)]}),
     (D8, {'entities': [(336, 349, lb), (562, 575, lb), (1236, 1249, lb), (1915, 1928, lb), (2007, 2012, lb),
                        ...
                        (2707, 2742, cs)]}),
     (D9, {'entities': [(807, 832, dv), (1127, 1137, pl), (1140, 1144, pl), (1145, 1148, pl), (1151, 1156, lb),
                        (1168, 1183, dv), (1933, 1990, we), (2788, 2790, pl), (2849, 2851, pl), (2814, 2820, lb),
                        (2842, 2848, lb), (2865, 2873, lb), (2874, 2878, lb), (2879, 2886, lb), (2887, 2892, lb),
                        (2893, 2906, lb), (2907, 2911, lb), (2912, 2922, ds), (2923, 2932, ds), (2933, 2938, ds),
                        (2939, 2952, lb), (2953, 2956, pf), (3168, 3174, pf), (3028, 3030, dv)]}),
     (D10, {'entities': [(242, 259, dv), (261, 263, dv), (3279, 3281, dv), (1748, 1771, dv), (1205, 1210, pf),
                         ...
                         (3716, 3719, pl), (2891, 2893, pl), (5069, 5071, pl), (3098, 3118, dv), (3721, 3725, lb),
                         (3727, 3734, lb), (3741, 3744, lb), (3745, 3750, lb), (3752, 3758, lb),
                         (3759, 3764, lb), (3766, 3772, pl), (3773, 3856, we), (3956, 3959, ap), (3992, 4008, pf)]})
